namespace HostsEditorOverUSB
{
    ...
    public unsafe class iPhone
    {
        ...
        public unsafe void startServiceOnDevice(string Service)
        {
            if (MobileDevice.AMDeviceStartService(this.iPhoneHandle, MobileDevice.CFStringMakeConstantString(Service), ref this.hService, null) != 0)
            {
