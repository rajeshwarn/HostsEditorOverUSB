namespace HostsEditorOverUSB
{
    ...
    internal class MobileDevice
    {
        ...
        [DllImport("lib/iTunesMobileDevice.dll", CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport("lib/iTunesMobileDevice.dll", EntryPoint="AMDeviceCopyValue", CallingConvention=CallingConvention.Cdecl)]
